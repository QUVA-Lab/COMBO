...
from GraphDecompositionBO.experiments.test_functions import PESTCONTROL_N_STAGES, CENTROID_N_EDGES, CENTROID_GRID, CENTROID_N_CHOICE, PESTCONTROL_N_CHOICE
from GraphDecompositionBO.experiments.test_functions import _pest_control_score, Centroid, ising_dense, partition, edge_choice
