...
def strong_product(adj_mat_list, beta, subset):
	'''
	...
	'''
	elm = subset[0]
	grouped_adjacency_id_added = beta[elm] * adj_mat_list[elm] + torch.diag(adj_mat_list[elm].new_ones(adj_mat_list[elm].size(0)))
